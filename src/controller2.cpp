...
bool Controller2::configure(yarp::os::ResourceFinder &rf) {

    Network yarp;
    yInfo()<<"Configuring the controller2 module...";
    ...
    /*
    * ret &= inPort.open("/controller2/in");
    * ret &= outPort.open("/controller2/out");
    */
...
double Controller2::getPeriod() {
    return period; // module periodicity (seconds)
}


bool Controller2::updateModule() {
	...
	//Check if stopFlag is acrive and send encoders readings to learning module
	if (stopFlag == true){
...
bool Controller2::respond(const Bottle& command, Bottle& reply) {
...
bool Controller2::interruptModule() {
...
bool Controller2::close() {
    yInfo()<<"closing controller2 module";
...
void Controller2::setDefaultLeftArmPosition (IPositionControl *arm_pos){
...
void Controller2::delWorldEnvironment (void){
...
void Controller2::setWorldEnvironment1 (void){
...
void Controller2::setWorldEnvironment2 (void){
...
void Controller2::setWorldEnvironment3 (void){
    ...
    cmd.addDouble(0.0);
    cmd.addDouble(0.7476);
    cmd.addDouble(0.374); //0.35-0.026
    cmd.addInt(1);
    cmd.addInt(0);
    cmd.addInt(0);
...
void Controller2::checkValidBabbling (void)
{
